...
const ServiceSection = ({ data }: ServiceSectionProps) => {
  ...
  useEffect(() => {
    ...
    emblaApi.scrollTo(0);
    updateScrollState();
  }, [emblaApi, services, updateScrollState]);
              ...
              <div className="overflow-hidden" ref={emblaRef}>
                <div className="flex gap-6 max-[500px]:gap-4">
                  {services.map((service) => (
                    ...
                    >
                      <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-[#F6FAFF] to-[#E7F4FF] shadow-inner">
