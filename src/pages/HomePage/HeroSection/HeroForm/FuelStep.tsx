        ...
        {availableFuelTypes.map((fuel) => {
          ...
          return (
            <button
              ...
              className={`flex min-h-[120px] flex-col items-center justify-center gap-2 rounded-2xl border border-transparent bg-white p-4 text-center text-[10px] font-medium text-[#2a1454] shadow-sm transition hover:-translate-y-1 hover:shadow-lg ${
            ...
            >
              ...
              <span className="leading-snug text-[#5b5f7d]">{fuel}</span>
            </button>
          );
        })}
      </div>
